...
describe("SequentialEngine SQLite", () => {
  ...
  test("should persist thoughts across sessions using sessionId", () => {
    ...
    engine.addThought("test thought", 1, 1, false, undefined, undefined, undefined, "session-123");
    engine.close();
  ...
  test("should isolate thoughts by sessionId", () => {
    const engine = new SequentialEngine(dbPath);
    engine.addThought("thought 1", 1, 1, false, undefined, undefined, undefined, "session-1");
    engine.addThought("thought 2", 1, 1, false, undefined, undefined, undefined, "session-2");
